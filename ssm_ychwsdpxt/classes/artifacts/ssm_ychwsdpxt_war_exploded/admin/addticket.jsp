...
<body class=" theme-blue">
	...
	<div class="content">
		<div class="header">
			<h1 class="page-title">新增票务信息</h1>
		</div>
		<div class="main-content">
			<div class="row">
				<div class="col-md-6 col-md-offset-3">
					<div id="myTabContent" class="tab-content">
						<form action="ticket/addTicket.action" name="myform" method="post" onsubmit="return check()" class="form">
							...
							<div class="tab-pane active in" id="home">
								<div class="form-group">
									<label>区域名称</label> <input type="text" name="areaname" class="form-control" id="areaname" placeholder="请输入区域名称" />
								</div>
							</div>
							<div class="tab-pane active in" id="home">
								<div class="form-group">
							...
							<div class="tab-pane active in" id="home">
								<div class="form-group">
									<label>总数</label> <input type="text" name="storage" class="form-control" id="storage" placeholder="请输入总数" />
								</div>
							</div>
